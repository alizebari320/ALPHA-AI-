...
$challenges = [
    ...
    5  => ['لینکێک زیاد بکە بۆ https://alpha-ai.com بە دەقی: Serdana Kurd AI', 'گرێدانەکەکا زیاد بکە بو https://alpha-ai.com ب دەقا: Serdana Kurd AI', array_merge($text('Serdana Kurd AI'), $attr('a', 'href', 'kurd-ai.com'))],
