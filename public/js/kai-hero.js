...
(function () {
    ...
    function mountSphere() {
        ...
        var palette = ['#b77b59', '#d8b5a1', '#d9b8a7', '#d0a296', '#c48c6c'];
        ...
        function frame() {
            ...
            for (var e = 0; e < edges.length; e += 2) {
                ...
                ctx.strokeStyle = 'rgba(183,123,89,' + al.toFixed(3) + ')';
                ctx.beginPath();
                ctx.moveTo(A.x, A.y);
                ctx.lineTo(B.x, B.y);
                ctx.stroke();
            ...
            g.addColorStop(0, 'rgba(185,135,110,0.22)');
            g.addColorStop(1, 'rgba(185,135,110,0)');
            ctx.fillStyle = g;
