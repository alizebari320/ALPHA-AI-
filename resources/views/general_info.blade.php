...
<meta charset="UTF-8">
    ...
    <meta property="og:url" content="https://alpha-ai.com/general-info">
    ...
    <meta property="twitter:url" content="https://alpha-ai.com/general-info">
...
<body class="bg-gray-50 text-gray-900 dark:bg-[#0a0f1c] dark:text-white min-h-screen transition-colors duration-300">
    ...
    <script type="module">
        ...
        const ADMIN_EMAILS = ["team@alpha-ai.com", "mahamadkamaran890@gmail.com"];
