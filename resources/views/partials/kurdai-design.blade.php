{{-- KURD AI — "Warm Editorial v11" design layer.
     Loaded last in <head> so it sits on top of Tailwind + each page's
     inline styles. Purely presentational: no tools, categories, courses,
     data or page logic depend on it.

     v11 replaces the "Nebula / Futuristic Glass" neon skin with a warm,
     humanized, editorial one:
       • kai-warm-palette.css re-paints every Tailwind colour utility onto
         warm terracotta / walnut / olive / stone ramps (selectors, markup
         and class names untouched — only the painted colours differ).
       • kai-human.css turns frosted glass into opaque warm paper, sets the
         Readex Pro type scale, flattens the buttons to a single accent, and
         switches off the decorative layers (star field, aurora sweeps, orbs,
         scan beams, glare, tilt, neon glow).
       • the cosmos canvas star-field script/sheet are no longer loaded, so
         those rAF loops and gradients are gone rather than merely hidden.
...
<link rel="stylesheet" href="/css/kurdai-design.css?v=16">
<link rel="stylesheet" href="/css/kurdai-nav.css?v=8">
<link rel="stylesheet" href="/css/kai-aurora-pro.css?v=6">
<link rel="stylesheet" href="/css/kai-warm-palette.css?v=1">
<link rel="stylesheet" href="/css/kai-human.css?v=1">
<script src="/js/kurdai-ui.js?v=12" data-kai-shared defer></script>
<script src="/js/kai-motion.js?v=5" data-kai-shared defer></script>
