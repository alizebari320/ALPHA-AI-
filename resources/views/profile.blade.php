...
<meta property="og:image" content="/logo.jpg">
    ...
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://alpha-ai.com/profile">
    ...
    <meta property="twitter:url" content="https://alpha-ai.com/profile">
        ...
        <div class="max-w-5xl mx-auto space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 glass-card rounded-[2rem] p-8 md:p-10 shadow-xl border border-white/30 dark:border-gray-700/30 backdrop-blur-xl animate-slide-up animation-delay-200">
                    ...
                    <p class="text-center text-sm text-gray-400 dark:text-gray-500 lang-str" data-so="لە داهاتوودا چالاکییەکانت و پێشکەوتنەکانت لێرەدا پیشان دەدرێت، کاتێک لە کۆرسەکان خوێندنت دەستپێکرد." data-ba="د پاشەڕۆژێ دا چالاکی و پێشکەفتنێن تە د ڤێرە دێ نیشان بدرن، دەمێ تو دەست ب خوێندنا کۆرسان بکی.">لە داهاتوودا چالاکییەکانت و پێشکەوتنەکانت لێرەدا پیشان دەدرێت.</p>
                </div>
    ...
    <script type="module">
        ...
        function renderFergaProgress() {
            ...
            if (langIds.length > 0) {
                html += `<div class="md:col-span-2 flex items-center gap-2 mt-2">
                    ...
                    <span class="font-black text-gray-900 dark:text-white lang-str" data-so="زمانەکان" data-ba="زمانان">زمانەکان</span>
        ...
        onAuthStateChanged((user) => { 
            if(!user) {
                ...
                const adminEmails = ["team@alpha-ai.com", "mahamadkamaran890@gmail.com"];
