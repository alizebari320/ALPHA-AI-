...
<meta charset="UTF-8">
    ...
    <meta property="og:url" content="https://alpha-ai.com/universities">
    ...
    <meta property="twitter:url" content="https://alpha-ai.com/universities">
...
<div class="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0">
    ...
    <script type="module">
        ...
        function subscribeUnis(fdb) {
            onValue(dbRef(fdb, 'universities'), (s) => { 
                unisData = s.val() || {}; 
                applyLanguage(); 
                updateAdminSelects(); 
                renderManageList(); 
